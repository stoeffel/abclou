...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Effect.Random.Extra"] = $PS["Effect.Random.Extra"] || {};
  var exports = $PS["Effect.Random.Extra"];
  var Control_Applicative = $PS["Control.Applicative"];
  ...
  var randomElement = function (xs) {
      var fallback = Data_Array_NonEmpty.head(xs);
      return function __do() {
          var index = Effect_Random.randomInt(0)(Data_Array_NonEmpty.length(xs))();
          return Data_Maybe.fromMaybe(fallback)(Data_Array_NonEmpty.index(xs)(index));
      };
  };
  var randomUniqElements = function (dictEq) {
      return function (v) {
          return function (xs) {
              ...
              if (v === 1) {
                  return Data_Functor.map(Effect.functorEffect)(function ($8) {
                      return Data_Maybe.Just.create(Data_Array_NonEmpty.singleton($8));
                  })(randomElement(xs));
              };
              return function __do() {
                  var x = randomElement(xs)();
                  var v1 = Data_Array_NonEmpty.fromArray(Data_Array_NonEmpty.filter(function (v2) {
                  ...
                  throw new Error("Failed pattern match at Effect.Random.Extra (line 24, column 5 - line 28, column 30): " + [ v1.constructor.name ]);
              };
          };
      };
  };
  exports["randomUniqElements"] = randomUniqElements;
...
(function($PS) {
  ...
  var letters = Data_Functor.map(Data_Array_NonEmpty_Internal.functorNonEmptyArray)(Letter.create)(Data_Array_NonEmpty["cons'"]("a")([ "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z" ]));
  var letterEq = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.value0 === y.value0;
      };
  });
  var letterOrd = new Data_Ord.Ord(function () {
      return letterEq;
  }, function (x) {
      return function (y) {
  ...
  var isEnabledEq = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Enabled && y instanceof Enabled) {
              return true;
          };
  ...
  var render = function (state1) {
      return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title(state1.letter.value0), Halogen_HTML_Properties.enabled(Data_Eq.eq(isEnabledEq)(state1.isEnabled)(Enabled.value)), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(Select.value);
      }) ])([ Halogen_HTML_Core.text(state1.letter.value0) ]);
  };
      ...
      if (v instanceof Select) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  $33.selected = !st.selected;
                  return $33;
              })()))(function () {
                  return Halogen_Query_HalogenM.raise(new Selected(st.letter));
              });
          });
      };
      if (v instanceof HandleInput) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(isEnabledEq)(st.isEnabled)(v.value0.isEnabled))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  var $36 = {};
                  for (var $37 in st) {
                  ...
                  $36.isEnabled = v.value0.isEnabled;
                  return $36;
              })()));
          });
      };
      throw new Error("Failed pattern match at Letter (line 90, column 16 - line 97, column 74): " + [ v.constructor.name ]);
  };
  var fallback = Data_Array_NonEmpty.singleton(new Letter("a"));
  var disable = function (state1) {
      return {
          selected: state1.selected,
          letter: state1.letter,
          isEnabled: Disabled.value
      };
  };
  ...
  exports["letterEq"] = letterEq;
  exports["letterOrd"] = letterOrd;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  ...
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  var Effect_Class = $PS["Effect.Class"];
  var Effect_Random_Extra = $PS["Effect.Random.Extra"];
  ...
  var TryAgain = (function () {
      function TryAgain(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      TryAgain.create = function (value0) {
          return function (value1) {
              return new TryAgain(value0, value1);
          };
      };
      return TryAgain;
  })();
  ...
  var LetterMessage = (function () {
      function LetterMessage(value0) {
          this.value0 = value0;
      };
      LetterMessage.create = function (value0) {
          return new LetterMessage(value0);
      };
  ...
  var randomQuiz = function __do() {
      var letters = Data_Functor.map(Effect.functorEffect)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Array_NonEmpty_Internal.functorNonEmptyArray)(Letter.state))(Data_Maybe.fromMaybe(Letter.fallback)))(Effect_Random_Extra.randomUniqElements(Letter.letterEq)(3)(Letter.letters))();
      var correct = Effect_Random_Extra.randomElement(letters)();
      return {
          correct: correct,
          letters: letters
      };
  };
  var intermission = Effect_Aff.delay(1500.0);
  var nextGame = function (v) {
      if (v instanceof Correct) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(intermission)(function () {
              return Data_Functor.map(Effect_Aff.functorAff)(Started.create)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(randomQuiz));
          });
      };
      if (v instanceof TryAgain) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(intermission)(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Started(v.value1));
          });
      };
  ...
  var disable = function (l) {
      return function (st) {
          if (Data_Eq.eq(Letter.letterEq)(st.letter)(l)) {
              return Letter.disable(st);
          };
          if (Data_Boolean.otherwise) {
              return st;
          };
  ...
  var handleAction = function (v) {
      if (v instanceof Initialize) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(randomQuiz))(function (quiz) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return new Started(quiz);
              }))(function () {
                  return Halogen_Query_HalogenM.raise(Initialized.value);
              });
          });
      };
      if (v instanceof LetterMessage) {
          return handleLetterMessage(v.value0);
      };
      throw new Error("Failed pattern match at Main (line 92, column 16 - line 97, column 47): " + [ v.constructor.name ]);
  };
  var _letter = Data_Symbol.SProxy.value;
  var viewLetter = function (v) {
      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "letter";
      }))(Letter.letterOrd)(_letter)(v.letter)(Letter.component)({
          letter: v.letter,
          isEnabled: v.isEnabled
      })(function ($31) {
          return Data_Maybe.Just.create(LetterMessage.create($31));
      });
  };
  var viewQuiz = function (quiz) {
      return Halogen_HTML_Elements.div_([ viewLetter(quiz.correct), Halogen_HTML_Elements.ul_(Data_Array_NonEmpty.toArray(Data_Functor.map(Data_Array_NonEmpty_Internal.functorNonEmptyArray)(viewLetter)(quiz.letters))) ]);
  };
  var render = function (v) {
      if (v instanceof NotStarted) {
          return Halogen_HTML_Core.text("Ein Moment...");
      };
      if (v instanceof Correct) {
          return Halogen_HTML_Core.text("Correct!");
      };
      if (v instanceof Started) {
          return viewQuiz(v.value0);
      };
      if (v instanceof TryAgain) {
          return Halogen_HTML_Core.text("Try again");
      };
      throw new Error("Failed pattern match at Main (line 72, column 1 - line 72, column 35): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
  ...
  exports["main"] = main;
  exports["LetterMessage"] = LetterMessage;
  exports["Initialize"] = Initialize;
  ...
  exports["viewLetter"] = viewLetter;
  exports["handleAction"] = handleAction;
  exports["handleLetterMessage"] = handleLetterMessage;
  exports["nextGame"] = nextGame;
  exports["maybeNewGame"] = maybeNewGame;
  exports["disable"] = disable;
  exports["intermission"] = intermission;
  exports["randomQuiz"] = randomQuiz;
})(PS);
PS["Main"].main();
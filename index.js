...
(function($PS) {
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title(state.letter), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(Select.value);
      }) ])([ Halogen_HTML_Core.text(state.letter) ]);
  };
  ...
  var handleAction = function (v) {
      ...
      if (v instanceof HandleInput) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(state.letter !== v.value0)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  var $5 = {};
                  for (var $6 in state) {
      ...
      throw new Error("Failed pattern match at Letter (line 47, column 16 - line 51, column 74): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      ...
      "eval": Halogen_Component.mkEval({
          ...
          receive: function ($9) {
              return Data_Maybe.Just.create(HandleInput.create($9));
          },
...
(function($PS) {
  ...
  var HandleLetterUpdate = (function () {
      function HandleLetterUpdate(value0) {
          this.value0 = value0;
      };
      HandleLetterUpdate.create = function (value0) {
          return new HandleLetterUpdate(value0);
      };
      return HandleLetterUpdate;
  })();
  ...
  var handleAction = function (v) {
      ...
      if (v instanceof HandleLetterUpdate) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              var $10 = {};
              for (var $11 in st) {
      ...
      throw new Error("Failed pattern match at Main (line 65, column 16 - line 67, column 71): " + [ v.constructor.name ]);
  };
  var _letter = Data_Symbol.SProxy.value;
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.ul_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "letter";
      }))(Data_Ord.ordInt)(_letter)(0)(Letter.component)("A")(function ($14) {
          return Data_Maybe.Just.create(HandleLetterUpdate.create($14));
      }), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "letter";
      }))(Data_Ord.ordInt)(_letter)(1)(Letter.component)("B")(function ($15) {
          return Data_Maybe.Just.create(HandleLetterUpdate.create($15));
      }) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("+1 == " + Data_Show.show(Data_Show.showInt)(state.test)), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(Increase.value);
      }) ])([ Halogen_HTML_Core.text("+1 == " + Data_Show.show(Data_Show.showInt)(state.test)) ]) ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
  ...
  exports["HandleLetterUpdate"] = HandleLetterUpdate;

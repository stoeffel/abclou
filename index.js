...
(function($PS) {
  ...
  var random = Effect_Random_Extra.randomElement(Data_Functor.map(Data_Array_NonEmpty_Internal.functorNonEmptyArray)(Letter.create)(Data_Array_NonEmpty["cons'"]("a")([ "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z" ])));
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Letter (line 66, column 16 - line 72, column 74): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var randomQuiz = function __do() {
      var first = Letter.random();
      var letters = Data_Foldable.foldM(Data_Foldable.foldableArray)(Effect.monadEffect)(function (acc) {
          return function (v) {
              return Control_Bind.bind(Effect.bindEffect)(Letter.random)((function () {
                  var $20 = Control_Applicative.pure(Effect.applicativeEffect);
                  var $21 = Data_Array_NonEmpty.snoc(acc);
                  return function ($22) {
                      return $20($21($22));
                  };
              })());
          };
      })(Data_Array_NonEmpty.singleton(first))(Data_Array.range(1)(3))();
  ...
  var maybeCorrect = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main (line 103, column 1 - line 103, column 41): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var handleLetterMessage = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(maybeCorrect(v.value0)))(function () {

...
(function($PS) {
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title(state.letter.value0), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(Select.value);
      }) ])([ Halogen_HTML_Core.text(state.letter.value0) ]);
  };
  ...
  var initialState = function (letter) {
      return {
          selected: false,
          letter: letter
      };
  ...
  var handleAction = function (v) {
      if (v instanceof Select) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
              return Halogen_Query_HalogenM.raise(new Selected(state.letter));
          });
      };
      if (v instanceof HandleInput) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(letterEq)(state.letter)(v.value0))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  var $23 = {};
                  for (var $24 in state) {
      ...
      throw new Error("Failed pattern match at Letter (line 67, column 16 - line 73, column 74): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var randomQuiz = function __do() {
      var letters = Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe(Letter.fallback))(Effect_Random_Extra.randomUniqElements(Letter.letterEq)(3)(Letter.letters))();
  ...
  var maybeCorrect = function (v) {
      return function (v1) {
          if (v1 instanceof NotStarted) {
              return NotStarted.value;
          };
          if (v1 instanceof Correct) {
              return v1;
          };
          if (v1 instanceof Started) {
              if (Data_Eq.eq(Letter.letterEq)(v1.value0.correct)(v)) {
          ...
          throw new Error("Failed pattern match at Main (line 111, column 1 - line 111, column 41): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var handleLetterMessage = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(maybeCorrect(v.value0)))(function (game) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(maybeNewGame(game)))(function (nextGame) {
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 90, column 16 - line 95, column 47): " + [ v.constructor.name ]);
  };
  var _letter = Data_Symbol.SProxy.value;
  var viewLetter = function (letter) {
      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "letter";
      }))(Letter.letterOrd)(_letter)(letter)(Letter.component)(letter)(function ($23) {
          return Data_Maybe.Just.create(LetterMessage.create($23));
      });
  };
  ...
  var render = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 71, column 1 - line 71, column 35): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
  ...
  exports["maybeCorrect"] = maybeCorrect;

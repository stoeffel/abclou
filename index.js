...
(function($PS) {
  ...
  var handleAction = function (v) {
      if (v instanceof Select) {
          return Halogen_Query_HalogenM.raise(Selected.value);
      };
      ...
      throw new Error("Failed pattern match at Letter (line 66, column 16 - line 70, column 74): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var LetterMessage = (function () {
      function LetterMessage(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      LetterMessage.create = function (value0) {
          return function (value1) {
              return new LetterMessage(value0, value1);
          };
      };
  ...
  var randomQuiz = function __do() {
      var correct = Effect_Random.randomInt(0)(3)();
      ...
      var letters = Data_Foldable.foldM(Data_Foldable.foldableArray)(Effect.monadEffect)(function (acc) {
          return function (v) {
              return Control_Bind.bind(Effect.bindEffect)(Letter.random)((function () {
                  ...
                  var $12 = Data_Array_NonEmpty.snoc(acc);
                  return function ($13) {
                      return $11($12($13));
                  };
              })());
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 81, column 16 - line 86, column 40): " + [ v.constructor.name ]);
  };
  ...
  var viewLetter = function (letter) {
      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "letter";
      }))(Letter.letterOrd)(_letter)(letter)(Letter.component)(letter)((function () {
          var $14 = LetterMessage.create(letter);
          return function ($15) {
  ...
  var render = function (v) {
      ...
      if (v instanceof Started) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(v.value0.correct)), Halogen_HTML_Elements.ul_(Data_Array_NonEmpty.toArray(Data_Functor.map(Data_Array_NonEmpty_Internal.functorNonEmptyArray)(viewLetter)(v.value0.letters))) ]);
      };
      throw new Error("Failed pattern match at Main (line 66, column 1 - line 66, column 64): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
